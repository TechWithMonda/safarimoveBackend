...
SECRET_KEY = 'django-insecure-+9t!nn-@bd@f4)&pbv=7j1(63@1rm)6*5$g=ldtv90#ac5oj9w'
...
CHANNEL_LAYERS = {
    "default": {
        "BACKEND": "channels_redis.core.RedisChannelLayer",
        "CONFIG": {
            "hosts": [os.environ.get("REDIS_URL")],  # Railway provides this
        },
    },
}
MIDDLEWARE = [
...
ROOT_URLCONF = 'nairobi_connect.urls'
